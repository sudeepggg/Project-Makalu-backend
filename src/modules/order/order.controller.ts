...
export const orderController = {
  ...
  async get(req: any, res: Response, next: NextFunction) {
    try {
      ...
      res.json(successResponse("Order", r));
    } catch (err) {
      next(err);
    }
  },
  ...
  async confirm(req: any, res: Response, next: NextFunction) {
    try {
      const r = await orderService.confirmOrder(req.params.id);
      res.json(successResponse("Order confirmed", r));
    } catch (err) {
      next(err);
    }
  },
  ...
  async dispatch(req: any, res: Response, next: NextFunction) {
    try {
      const r = await orderService.dispatchOrder(req.params.id);
      res.json(successResponse("Order dispatched", r));
    } catch (err) {
      next(err);
    }
  },
